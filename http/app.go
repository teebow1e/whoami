...
func whoamiHandler(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprintln(w, "Hello, world! BOOM—here we go!")
	fmt.Fprintln(w, "If these words are blazing across your screen, your connection to the remote server is LIVE and kicking!")
	fmt.Fprintln(w, "Ready for some juicy connection details? Check this out:")
	fmt.Fprintln(w, "")
